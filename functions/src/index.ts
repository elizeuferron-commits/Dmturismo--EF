 ...
 */
export const triggerManualBackup = onRequest(
  {
    cors: true,
    memory: "512MiB",
    timeoutSeconds: 300
 ...
 */
export const onTripScheduled = onDocumentCreated(
  {
 ...
 */
export const onUrgentMaintenanceAlert = onDocumentCreated(
  {
...
// Import and export schedule notification function and cleanup tasks to make them active and deployable
export { checkExpirationsAndNotify } from "./expirationAlerts";
export { scheduledAuditLogsCleanup, scheduledDatabaseCleanup } from "./cleanupTasks";
